...
from vid2im import ims2vid, vid2ims
...
def main():
    ...
    parser.add_argument('--input_video', type=str, default='images', help='Input video')
    parser.add_argument('--output_video_path', type=str, default='out.mp4', help='Output folder to save rendered results')
    ...
    vid2ims(args.input_video, input_image_folder)
    ...
    img_paths = sorted(glob(os.path.join(input_image_folder, "*.png")))
    ...
    ims2vid(out_folder, args.output_video_path)
